...
public class SearchAnimationToolbar extends FrameLayout implements TextWatcher {
    ...
    private void bindAttributes(AttributeSet attrs) {
        ...
        toolbarTitleColor = typedArray.getColor(R.styleable.SearchAnimationToolbar_titleTextColor, Color.BLACK);
        toolbarSubtitle = typedArray.getString(R.styleable.SearchAnimationToolbar_subtitle);
        toolbarSubtitleColor = typedArray.getColor(R.styleable.SearchAnimationToolbar_subtitleTextColor, Color.BLACK);
        ...
        searchBackgroundColor = typedArray.getColor(R.styleable.SearchAnimationToolbar_searchBackgroundColor, Color.BLACK);
