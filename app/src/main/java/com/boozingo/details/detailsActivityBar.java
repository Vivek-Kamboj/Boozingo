...
public class detailsActivityBar extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(detailsActivityBar.this, "Coming soon", Toast.LENGTH_SHORT).show();
            }
        });
