...
import com.boozingo.model.detailsPub;
...
public class detailsActivityPub extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position) {
                    case 0:
                        dot1.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.ring));
                        dot2.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        break;

                    case 1:
                        dot1.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        dot2.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.ring));
                        dot3.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        break;
                    case 2:
                        dot2.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        dot3.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.ring));
                        //            dot4.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        break;
                   /* case 3:
                        dot3.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        dot4.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.ring));
                        dot5.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        break;
                    case 4:
                        dot4.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        dot5.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.ring));
                        dot6.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        break;
                    case 5:
                        dot5.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.dot));
                        dot6.setImageDrawable(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.ring));
                        break;*/
                }
            }
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /*String url = "http://www.stackoverflow.com";
                ...
                Toast.makeText(detailsActivityPub.this, "Coming soon", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            switch (i) {
                ...
                case 1:
                    if (details.getPub_food().equals("both") || details.getPub_food().equals("veg")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.veg));
                        text.setText("Veg");
                        icons.addView(child);
                    }
                    break;
                case 2:
                    if (details.getPub_food().equals("both") || details.getPub_food().equals("nonveg")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityPub.this, R.drawable.non_veg));
                ...
                case 3:
                    if (details.getPub_sitting_facility().equals("yes")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityPub.this, R.raw.table));
                ...
                case 4:
                    if (details.getPub_music().equals("available")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityPub.this, R.raw.music_player));
                        text.setText("Music");
                        icons.addView(child);
                    }
                    break;
                case 5:
                    if (details.getPub_ac().equals("ac")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityPub.this, R.raw.minisplit1));
                        text.setText("Ac");
                        icons.addView(child);
                    }
                    break;
                case 6:
                    if (details.getPub_payment().equals("cash") || details.getPub_payment().equals("all")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityPub.this, R.raw.notes));
                        text.setText("Cash");
                        icons.addView(child);
                    }
                    break;
                case 7:
                    if (details.getPub_payment().equals("credit/debit card") || details.getPub_payment().equals("all")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityPub.this, R.raw.credit_card));
                        text.setText("Card");
                        icons.addView(child);
                    }
                    break;
