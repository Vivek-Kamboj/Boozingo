...
public class detailsActivityLounge extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks {
    ...
    private void detailsRequest() {
        ...
        final String url = URL + "lounge/" + id;
        ...
        jsonObjReq = new JsonObjectRequest(Request.Method.GET,
...

                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        showError(error, detailsActivityLounge.this);
                        pDialog.dismiss();
                    }
                });
