...
import com.boozingo.model.detailsLounge;
...
import static com.boozingo.Boozingo.share_message;
...
public class detailsActivityLounge extends AppCompatActivity implements SnackBarClass.SnackbarMessage, GoogleApiClient.ConnectionCallbacks {

    ViewPager viewPager;
    String TAG = "TAG", id = "2", text, geo_location, latitudeLounge, longitudeLounge, image, specs, cost, _type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position) {
                    case 0:
                        dot1.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.ring));
                        dot2.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        break;

                    case 1:
                        dot1.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        dot2.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.ring));
                        dot3.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        break;
                    case 2:
                        dot2.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        dot3.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.ring));
                        //            dot4.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        break;
                   /* case 3:
                        dot3.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        dot4.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.ring));
                        dot5.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        break;
                    case 4:
                        dot4.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        dot5.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.ring));
                        dot6.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        break;
                    case 5:
                        dot5.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.dot));
                        dot6.setImageDrawable(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.ring));
                        break;*/
                }
            }
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /*String url = "http://www.stackoverflow.com";
                ...
                Toast.makeText(detailsActivityLounge.this, "Coming soon", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            specs = details.getLounge_details();
                            cost = details.getLounge_cost();
                            ...
                            String path = "http://maps.google.com/maps/api/staticmap?&zoom=19&size=600x240&markers=color:blue|" + latitudeLounge + "," + longitudeLounge;

                            Glide.with(detailsActivityLounge.this)
                                    .load(path)
                                    .into(frag);
            ...
            switch (i) {
                ...
                case 1:
                    if (details.getLounge_food().equals("both") || details.getLounge_food().equals("veg")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.veg));
                        text.setText("Veg");
                        icons.addView(child);
                    }
                    break;
                case 2:
                    if (details.getLounge_food().equals("both") || details.getLounge_food().equals("nonveg")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityLounge.this, R.drawable.non_veg));
                ...
                case 3:
                    if (details.getLounge_sitting_facility().equals("yes")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityLounge.this, R.raw.table));
                ...
                case 4:
                    if (details.getLounge_music().equals("available")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityLounge.this, R.raw.music_player));
                        text.setText("Music");
                        icons.addView(child);
                    }
                    break;
                case 5:
                    if (details.getLounge_ac().equals("ac")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityLounge.this, R.raw.minisplit1));
                        text.setText("Ac");
                        icons.addView(child);
                    }
                    break;
                case 6:
                    if (details.getLounge_payment().equals("cash") || details.getLounge_payment().equals("all")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityLounge.this, R.raw.notes));
                        text.setText("Cash");
                        icons.addView(child);
                    }
                    break;
                case 7:
                    if (details.getLounge_payment().equals("credit/debit card") || details.getLounge_payment().equals("all")) {
                        x.setBackground(ContextCompat.getDrawable(detailsActivityLounge.this, R.raw.credit_card));
                        text.setText("Card");
                        icons.addView(child);
                    }
                    break;
