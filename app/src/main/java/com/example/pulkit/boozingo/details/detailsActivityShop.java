...
import com.example.pulkit.boozingo.model.detailsShop;
...
public class detailsActivityShop extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, ActivityCompat.OnRequestPermissionsResultCallback {

    ViewPager viewPager;
    ImageButton back;
    String TAG = "TAG", id = "2", text, geo_location, latitudeShop, longitudeShop, image;
 ...
 //       transparent = (ImageView) findViewById(R.id.imagetrans);
        ...
        pDialog = new ProgressDialog(detailsActivityShop.this);
        ...
        locator.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String uri = "http://maps.google.com/maps?f=d&hl=en&saddr=" + latitude + "," + longitude + "&daddr=" + latitudeShop + "," + longitudeShop;
    ...
    public void onMapReady(GoogleMap map) {
        map.addMarker(new MarkerOptions()
                .position(new LatLng(Float.parseFloat(latitudeShop), Float.parseFloat(longitudeShop)))
                .title("Marker"));

        map.moveCamera(CameraUpdateFactory.newLatLng(new LatLng(Float.parseFloat(latitudeShop), Float.parseFloat(longitudeShop))));
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    JSONArray array = object.getJSONArray("beer_shop_detail");
                    ...
                    details = gson.fromJson(userJson, detailsShop.class);
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            name.setText(details.getShop_name());
                            address.setText(details.getShop_address());
                            type.setText("(" + getIntent().getStringExtra("type") + ")");
                            timing.setText(details.getShop_time());
                            geo_location = details.getShop_geolocation();


                            int comma = geo_location.indexOf(',');
                            latitudeShop = geo_location.substring(0, comma);
                            longitudeShop = geo_location.substring(comma + 1);

                            mapFragment.getMapAsync(detailsActivityShop.this);
                            ...
                            adapter = new picPagerAdapter(detailsActivityShop.this, images);
    ...
    private void facilities() {
        for (int i = 0; i < 7; i++) {
            ...
            switch (i) {
               /* case 0:
                    if(details.getShop_food().equals("both") || details.getShop_food().equals("veg")) {
                    ...
                    break;
                case 1:
                    if(details.getShop_food().equals("both") || details.getShop_food().equals("nonveg")) {
                    ...
                    break;
                case 2:
                    if(details.getShop_sitting_facility().equals("yes")) {
                    ...
                    break;
                case 3:
                    if(details.getShop_music().equals("available")) {
                    ...
                    break;
                case 4:
                    if(details.getShop_ac().equals("ac")) {
                    ...
                    break;*/
                case 5:
                    if(details.getShop_payment().equals("cash") || details.getShop_payment().equals("all") ) {
                    ...
                    break;
                case 6:
                    if(details.getShop_payment().equals("credit/debit card") || details.getShop_payment().equals("all") ) {
