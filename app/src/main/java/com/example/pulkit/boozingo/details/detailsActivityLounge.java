...
public class detailsActivityLounge extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    ViewPager viewPager;
    ImageButton back;
    String TAG = "TAG", id = "2", text, geo_location, latitudeLounge, longitudeLounge, image, specs;
        ...
        locator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(marshmallowPermissions.checkPermissionForCoarseLocation() && marshmallowPermissions.checkPermissionForFineLocation()) {
                    ...
                    Toast.makeText(detailsActivityLounge.this, "Please allow us to use locations.", Toast.LENGTH_SHORT).show();
/*
...
*/
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(new LatLng(Float.parseFloat(latitudeLounge), Float.parseFloat(longitudeLounge)))
                .zoom(15)
                .build();
