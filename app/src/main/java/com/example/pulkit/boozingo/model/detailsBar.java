...
public class detailsBar {
    ...
    public void setBar_booze_served(String bar_booze_served) {
        this.bar_booze_served = bar_booze_served;
    }
    ...
    public void setBar_details(String bar_details) {
        this.bar_details = bar_details;
    }
    ...
    public void setBar_food(String bar_food) {
        this.bar_food = bar_food;
    }
    ...
    public void setBar_geolocation(String bar_geolocation) {
        this.bar_geolocation = bar_geolocation;
    }
    ...
    public void setBar_images(String bar_images) {
        this.bar_images = bar_images;
    }
    ...
    public void setBar_music(String bar_music) {
        this.bar_music = bar_music;
    }
    ...
    public void setBar_payment(String bar_payment) {
        this.bar_payment = bar_payment;
    }
    ...
    public void setBar_sitting_facility(String bar_sitting_facility) {
        this.bar_sitting_facility = bar_sitting_facility;
    }
    ...
    public void setBar_ac(String bar_ac) {
        this.bar_ac = bar_ac;
    }
}
